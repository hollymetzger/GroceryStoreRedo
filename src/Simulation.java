...
public class Simulation {
    ...
    private NormalDistribution numberOfItemsRNG;

    public Simulation(ArrivalProcess arrivalGenerator, CustomQueue<SingleServerQueue> queues, NormalDistribution numberOfItemsRNG) {
        this.currentTime = 0.0;
        this.queues = queues;
        this.arrivalGenerator = arrivalGenerator;
        this.completedJobs = new CustomQueue<Job>();
        this.numberOfItemsRNG = numberOfItemsRNG;
    }
    ...
    private void doLoop() {
        ...
        if (nextArrivalTime < nextServiceCompletionTime) {
            ...
            Job newJob = arrivalGenerator.nextJob(currentTime, numberOfItemsRNG);
            placeJob(newJob);
        } else {
    ...
    public static void testJobs() {
        ...
        Simulation simulation = new Simulation(arrivalGenerator, queues, numberOfItemsRNG);
        ...
        while (current != null) {
            Customer cus = (Customer) current.getData();
    ...
    public static void doUnitTests() {
        ...
        Simulation simulation = new Simulation(mockArrivalGenerator, queues, numberOfItemsRNG);
